    ...
    <div>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" BorderStyle="Dotted" ControlToValidate="tbTel" ErrorMessage="Bledny telefon" ForeColor="#FF0066" ValidationExpression="^([\+]?(?:00)?[0-9]{1,3}[\s.-]?[0-9]{1,12})([\s.-]?[0-9]{1,4}?)$"></asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
