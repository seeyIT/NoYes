...
// oprocz siebie ---- client.broadcast.emit("buildBrick", { position: data });
// do sibie tylko ---- io.sockets.to(client.id).emit("rejestracja", {});
// do wszystkich ----- io.sockets.emit("mouseposition", { posX: data.posX, posY:data.posY }); 


io.on('connection', function (client) {

    //client.on("getDirectories", function (data) {
